...
for exchange in orders_list:
    ...
    aim_token_ids_2 = torch.tensor([362, 425, 356, 422, 468]).to(model.device)
    ...
    if args.restart == 'n':
        ...
        save_path = f'/Data/datasets/Option order results/{args.dataset}/LLM results/GLM4/prompt{args.prompt}_{args.subset}_results_{result_file_name}.jsonl'
        finished_num = 0
